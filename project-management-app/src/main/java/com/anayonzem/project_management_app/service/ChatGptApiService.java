...
public class ChatGptApiService {
    ...
    public Task getTaskObject(String prompt) {
        String context = "You are a very helpful assistant that transforms a given task description into JSON. The JSON must have fields: 'name' (string), 'description' (string), 'deadline' (ISO 8601 format), and 'priority' (high, medium, or low).";
